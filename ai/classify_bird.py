...
MODEL_PATH = os.path.join(os.path.dirname(__file__), "model", "efficientnet_b7_backyard-birds.onnx")
LABELS_PATH = os.path.join(os.path.dirname(__file__), "model", "class_labels.txt")
